...
@Component({
  selector: 'app-principle4',
  templateUrl: './principle4.component.html',
  styleUrls: ['./principle4.component.scss']
})
export class Principle4Component {
  ...
  constructor(
   ...
   async getDataInfo(page: number, pageSize: number): Promise<void> {
     try {
       this.loading = true
       const data: any = await this.indicatorService.getDataById('4', this.searchText).toPromise();
  ...
  private handleApiResponse(data: any, element: any, type: string) {
   ...
   openDialog(action: string, obj: ObjectiveModel): void {
     ...
     const dialogRef = this.dialog.open(DialogPrinciple4Component, {
       data: {
         param1: obj,
...
@Component({
  ...
  selector: 'app-dialog-principle4',
  templateUrl: './dialog-principle4.html'
})
// tslint:disable-next-line: component-class-suffix
export class DialogPrinciple4Component implements OnInit {
  action: string;
  ...
  constructor(
    public datePipe: DatePipe,
    public dialogRef: MatDialogRef<DialogPrinciple4Component>,
