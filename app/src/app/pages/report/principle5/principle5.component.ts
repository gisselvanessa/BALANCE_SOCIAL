...
@Component({
  selector: 'app-principle5',
  templateUrl: './principle5.component.html',
  styleUrls: ['./principle5.component.scss']
})
export class Principle5Component {
  ...
  async getDataInfo(page: number, pageSize: number): Promise<void> {
    try {
      this.loading = true
      const data: any = await this.indicatorService.getDataById('5', this.searchText).toPromise();
  ...
  openDialog(action: string, obj: ObjectiveModel): void {
    ...
    const dialogRef = this.dialog.open(DialogPrinciple5Component, {
      data: {
        param1: obj,
...
@Component({
  ...
  selector: 'app-dialog-principle5',
  templateUrl: './dialog-principle5.html'
})
// tslint:disable-next-line: component-class-suffix
export class DialogPrinciple5Component implements OnInit {
  action: string;
  ...
  constructor(
    public datePipe: DatePipe,
    public dialogRef: MatDialogRef<DialogPrinciple5Component>,
