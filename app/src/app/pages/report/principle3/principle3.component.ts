...
@Component({
  selector: 'app-principle3',
  templateUrl: './principle3.component.html',
  styleUrls: ['./principle3.component.scss']
})
export class Principle3Component {
  ...
  async getDataInfo(page: number, pageSize: number): Promise<void> {
    try {
      this.loading = true
      const data: any = await this.indicatorService.getDataById('3', this.searchText).toPromise();
  ...
  openDialog(action: string, obj: ObjectiveModel): void {
    ...
    const dialogRef = this.dialog.open(DialogPrinciple3Component, {
      data: {
        param1: obj,
...
@Component({
  ...
  selector: 'app-dialog-principle3',
  templateUrl: './dialog-principle3.html'
})
// tslint:disable-next-line: component-class-suffix
export class DialogPrinciple3Component implements OnInit {
  action: string;
  ...
  constructor(
    public datePipe: DatePipe,
    public dialogRef: MatDialogRef<DialogPrinciple3Component>,
