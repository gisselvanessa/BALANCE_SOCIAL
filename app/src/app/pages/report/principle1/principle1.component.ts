...
@Component({
  selector: 'app-principle1',
  templateUrl: './principle1.component.html',
  styleUrls: ['./principle1.component.scss']
})
export class Principle1Component {
  ...
  async ngOnInit(): Promise<void> {
    ...
    // this.setStep(this.local_data[0].idclasificacion);
  ...
  async getDataInfo(page: number, pageSize: number): Promise<void> {
    try {
      const data: any = await this.indicatorService.getDataById('1', this.searchText).toPromise();
  ...
  // async validateElementPromedio(element: any): Promise<string | null> {
  //   if (element.operacion === 'División' || element.operacion === 'División - 1') {
  //     if (element.numerador && element.denominador) {
  //       if (Number(element.numerador) < Number(element.denominador)) {
  //         console.log('hiii1');
  //         return 'El numerador es menor que el denominador';
  //       }
  //     }
  //     if (element.numerador && !element.denominador && element.valor_denominador) {
  //       if (Number(element.numerador) < Number(element.valor_denominador)) {
  //         console.log('hi2');
  //         return 'El valor del numerador es menor que el valor del denominador';
  //       }
  //     }
  //     if (element.denominador && !element.numerador && element.valor_numerador) {
  //       if (Number(element.valor_numerador) < Number(element.denominador)) {
  ...
  async saveValues(element: any) {
    ...
    try {
      ...
      if (element.operacion === 'División' || element.operacion === 'División - 1') {
        ...
        if (element.relacionproporcion === 'Porcentaje' || element.relacionproporcion === "Promedio_Procentaje") {
        ...
        // if(element.relacionproporcion==='Promedio'){
        //   const validationMessage = await this.validateElementPromedio(element);
  ...
  openDialog(action: string, obj: ObjectiveModel): void {
    ...
    const dialogRef = this.dialog.open(DialogPrinciple1Component, {
      data: {
        param1: obj,
...
@Component({
  ...
  selector: 'app-dialog-principle1',
  templateUrl: './dialog-principle1.html'
})
// tslint:disable-next-line: component-class-suffix
export class DialogPrinciple1Component implements OnInit {
  action: string;
  ...
  constructor(
    public datePipe: DatePipe,
    public dialogRef: MatDialogRef<DialogPrinciple1Component>,
